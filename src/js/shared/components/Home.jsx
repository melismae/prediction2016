        ...
        return (
            <div id="container">
                ...
                <div id="selected-text">
                    ...
                    <p>According to <a href={source.url} target="_blank">{source.source}</a>, {candidates[winningParty].firstname} {candidates[winningParty].lastname} has a {source[winningParty]}% chance of winning, while {candidates[losingParty].firstname} {candidates[losingParty].lastname} has a {source[losingParty]}% chance of winning.</p>
